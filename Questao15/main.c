...
int main(void) {
  ...
  qsort(valores, n, sizeof(float), comparacao); // Recebe 4 parâmetros, um ponteiro para o 1º elemento do vetor, a quantidade de elementos, o tamanho (em bytes) de cada elemento e o último parâmetro recebe um ponteiro pra uma função que fará a comparação e retornará um valor maior que zero, menor que zero ou igual a zero;
